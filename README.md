...
When I came accross DDD a couple of years ago, I first thought it was the biggest revelation in my software developer carreer. I could relate what I have been doing to **Big Ball of Mud** as eric Evans coined it so well. After a lot of struglle learning DDD, I re-developped the IAM used by Vaun Vernnon in his book from scratch using Java 8. I then discover functional programing and it almost stop from me breathing as I could not stop wondering why the OOP is so mainstrain. It took me several months to transition from the OOP to FFP. One of my concrete realisation is converting an  [IAM System](https://suave.io) I previously implemented in Java using DDD  into a Functional F# Project. It's in this context that I set out to write this piece of software. This is an initial version that I Intend to improve in the comming months. I am currently working up to it's haskell version and in parallel using Elm to replace the [Angular UI](https://suave.io) that was implemented for the initial Java IAM
